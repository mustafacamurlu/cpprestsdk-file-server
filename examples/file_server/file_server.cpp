...
class file_controller : public base_controller
{
    ...
    public:
        ...
        file_controller(string public_key_uri, string base_path)
            :base_controller(public_key_uri),base(base_path)
        {
        }

        void list(endpoint_request req)
        {
            string out;
        ...
        void read(endpoint_request req)
        {
            std::string content;
        ...
        void write(endpoint_request req)
        {
        ...
        void fstat(endpoint_request req)
        {
            time_t tv;
            char date[36];
            struct stat buf;
        ...
        void endpoint_mapping()
        {
            ...
            set_route(U("/{filename}"),      web::http::methods::POST, bind(&file_controller::write, this, placeholders::_1), true);
            set_route(U("/{filename}"),      web::http::methods::DEL,  bind(&file_controller::del,   this, placeholders::_1), true);
        }
};
